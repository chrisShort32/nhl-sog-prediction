...
def main() -> None:
    ...
    print(f"Saving player_latest_v3.parquet at {ts}...")
    player_latest.to_parquet(OUT / "player_latest_v3.parquet", index=False)
    
    print(f"Saving df_model_v3.parquet at {ts}...")
    df.to_parquet(OUT / "df_model_v3.parquet", index=False)
